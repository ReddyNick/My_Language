//ASM_GENERATOR generates assembler code that is ready to compile by assembler
...
namespace ASM_Gen
{
    ...
    class Generator
    {
        ...
        //G - index of global vars
        //local_lvl - level of localness
        //label - current name of the vacant label
        int G = 0;
        int local_lvl = 0;
        int label = 0;
